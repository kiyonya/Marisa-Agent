...
type GeneratedTool<ToolParams extends Record<string, any> = {}, ToolResult = NonVoidToolResult<any>, Permissions = IPermissions> = LocalTool<ToolParams, ToolResult> | MCPTool<ToolParams, ToolResult>
...
export default class DynamicTool<ToolParams extends Record<string, any> = {}, ToolResult = NonVoidToolResult<any>, Permissions = IPermissions> {
    ...
    public static toDynamicTool<ToolParams extends Record<string, any> = {},ToolResult = NonVoidToolResult<any>,Permissions = IPermissions>(tool: LocalTool<ToolParams, ToolResult> | MCPTool<ToolParams, ToolResult>): DynamicTool<ToolParams, ToolResult, Permissions> {
