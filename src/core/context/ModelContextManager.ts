 ...
 *          - memory_search.db
 */
abstract class ModelContextIOEssential extends ModelComponent<Marisa.Events.ModelContextManager> {
...
export abstract class ModelContextManager extends ModelContextIOEssential {
    ...
    public createEmptyVectorStore<Metadata extends Record<string, any>>(dimension: number = 512) {
